...
class Instalike {
    ...
    private final Map <String,String> xpaths = Map.ofEntries(
            entry("login_button","//*[@id=\"loginForm\"]/div/div[3]/button/div"),//кнопка войти
            entry("first_photo", "/html/body/div[1]"),
            entry("like_button", "/html/body/div[5]/div[2]/div/article/div[3]/section[1]/span[1]/button/div"),
